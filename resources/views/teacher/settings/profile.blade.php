				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" method="POST" action="{{ route('teacher_profile') }}" enctype="multipart/form-data">
								@csrf
								<div class="">
									...
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control" type="" readonly value="{{Auth::user()->email}}">
											{{-- <span class="help">If you want your invoices addressed to a company. Leave blank to use your full name.</span> --}}
										</div>
									</div>
									<div class="form-group row">
										<label class="col-sm-2 col-form-label">Class Assigned</label>
										<div class="col-sm-7">
											<input class="form-control" type="" readonly value="{{$subject->name}}">
											{{-- <span class="help">If you want your invoices addressed to a company. Leave blank to use your full name.</span> --}}
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input class="form-control @error('mobile') is-invalid @enderror" name="mobile" type="text" value="{{Auth::user()->mobile}}">
                                            @error('mobile')
                                                <span class="invalid-feedback mb-2" role="alert" style="display: block">
                                                    <strong>{{ $message }}</strong>
                                                </span>
							...
							<form class="edit-profile" method="post" action="{{ url('teacher/change-password') }}">
                                @csrf
								<div class="">
									<div class="form-group row">
										<div class="col-sm-10 ml-auto">
