...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Teacher Dashboard - {{$title ?? ''}} </title>
    ...
    @include('teacher.layouts.includes.style')
    @include('teacher.layouts.includes.alert')
...
<body class="ttr-opened-sidebar ttr-pinned-sidebar">
    ...
    @include('teacher.layouts.includes.sidemenu')
