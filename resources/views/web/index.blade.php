                ...
                <ul>	<!-- SLIDE  -->
                    ...
                    data-description="Science says that Women are generally happier">
                        ...
                        <div class="tp-caption Newspaper-Title   tp-resizeme" 
                            ...
                            data-paddingleft="[0,0,0,0]"
                            style="z-index: 6; font-family:rubik; font-weight:500; text-align:center; white-space: normal;">
                                Welcome To Federal University<br> of Technology, Owerri <br>Assignment submission plartform
                        </div>
                ...
                <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                    ...
                    <div class="item">
                        <div class="cours-bx">
                            ...
                            <div class="info-bx text-center">
                                <h5><b><a href="#">School of Engineering and Engineering Technology</a></b></h5>
                                <h3>(SEET)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cours-bx">
                            ...
                            <div class="info-bx text-center">
                                <h5><b><a href="#">School of Health Technology</a></b></h5>
                                <h3>(SOHT)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cours-bx">
                            ...
                            <div class="info-bx text-center">
                                <h5><b><a href="#">School of Information and Communication Technology</a></b></h5>
                                <h3>(SICT)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cours-bx">
                            ...
                            <div class="info-bx text-center">
                                <h5><b><a href="#">School of Environmental Science</a></b></h5>
                                <h3>(SOES)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="cours-bx">
                            ...
                            <div class="info-bx text-center">
                                <h5><b><a href="#">School of Physical Science</a></b></h5>
                                <h3>(SOPS)</h3>
                            </div>
                        </div>
                    </div>
