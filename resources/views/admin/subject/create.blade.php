				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" method="POST" action="{{ route('admin_profile') }}" enctype="multipart/form-data">
								@csrf
								<div class="">
							...
							<form class="edit-profile" method="post" action="{{ url('admin/change-password') }}">
                                @csrf
								<div class="">
									<div class="form-group row">
										<div class="col-sm-10 ml-auto">
