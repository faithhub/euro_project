...
<head>
    ...
    @include('student.layouts.includes.style')
...
<body class="ttr-opened-sidebar ttr-pinned-sidebar">
	...
	<!-- header start -->
    @include('student.layouts.includes.header')
	<!-- header end -->
	<!-- Left sidebar menu start -->
    @include('student.layouts.includes.sidemenu')
...
@include('student.layouts.includes.script')
</body>
